...
int part1() {
    ...
    for (auto blueprint : blueprints) {
        ...
        for (int ore_rob_count = 1; ore_rob_count < 4; ore_rob_count++) {
            ...
            for (int i = 0; i < 24; i++) {
                ...
                if (robots[0] < ore_rob_count and minerals[0] >= blueprint[0][0]) {
                    robots[0]++;
                    new_robots[0]++;
                ...
                while (minerals[0] >= blueprint[3][0] and minerals[2] >= blueprint[3][2]) {
                    robots[3]++;
                    new_robots[3]++;
                ...
                if (blueprint[3][2] > minerals[2] 
                    ...
                    and blueprint[3][0] > (minerals[0] - blueprint[1][0] + robots[0])) {
                    
                }
                // Otherwise buy obsidian robots
                else {
                    while (minerals[0] >= blueprint[2][0] and minerals[1] >= blueprint[2][1]) {
                        robots[2]++;
                        new_robots[2]++;
                ...
                // Otherwise buy clay robots
                    ...
                    while (minerals[0] >= blueprint[1][0]) {
                        robots[1]++;
                        new_robots[1]++;
